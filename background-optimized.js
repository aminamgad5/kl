// Optimized Background script for ETA Invoice Exporter
class ETABackgroundOptimized {
    constructor() {
        this.init();
    }
    ...
    handleInstallation() {
        chrome.storage.local.set({
            ...
            version: '1.1.0',
            usageCount: 0,
            performanceMode: 'auto' // auto, fast, balanced, safe
        });
    ...
    async setPerformanceMode(mode) {
        ...
        // Notify content scripts about performance mode change
...
// Initialize optimized background script
new ETABackgroundOptimized();